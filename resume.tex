...
\begin{position}
    ...
    \vspace{-7mm}
    Project: Learning-Based Wireless Sensing for Health Care and Smart Home \\
    \Bullet{Develop a wireless fall detection system that generalizes to new homes and new people.}
    \Bullet{Build the first RF breathing monitoring system that works in multiple people scenarios.}
\end{position}
\vspace{-5mm}
