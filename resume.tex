...
\begin{position}
    ...
    \Bullet{Develop the first WiFi-based breathing monitoring system that extracts breathing signals from multiple people in one bed and is robust to human motions.}
\end{position}
\vspace{-5mm}
